        ...
        <div className="bg-card border-border rounded-md border p-6 shadow-xs md:p-8 lg:p-12">
          {hasPermission ? (
            ...
            <p className="text-destructive max-w-lg text-sm font-medium">
              You do not have permission to submit a review. If you&apos;d like
              to submit a review, please send us an email at{" "}
              <a href={`mailto:${env.NEXT_PUBLIC_RESEND_CONTACT_EMAIL}`}>
