...
export const QuoteComp = () => {
  return (
    <div className="from-secondary via-secondary/50 bg-linear-to-t to-transparent py-24 text-center lg:py-32">
      <Container className="space-y-12" size="xs">
        <div className="bg-foreground mx-auto h-24 w-px opacity-20" />
